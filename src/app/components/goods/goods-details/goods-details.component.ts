...
export class GoodsDetailsComponent implements OnInit {
  ...
  constructor(private goodsService:GoodsService,
    ...
    this.goodsForm = this.fb.group({
      ...
      "quantity": [{value: '', disabled: !this.hasRights}, Validators.compose([Validators.pattern(/^[\d]*$/)])],
      "quantityUnit": [{value: '', disabled: !this.hasRights}],
      "weight": [{value: '', disabled: !this.hasRights}, Validators.compose([Validators.pattern(/^[\d]*$/)])],
      "weightUnit": [{value: '', disabled: !this.hasRights}],
      "price": [{value: '', disabled: !this.hasRights}, Validators.compose([Validators.pattern(/^[\d]*$/)])],
